...
$result = mysqli_query($con,"SELECT * FROM groups WHERE grp='family'");
...
<br><br>
<tr>
<form action="http://localhost/project/msgfam.php">
<td><input type="submit" name="button1" value="SEND MESSAGE">
</td>
</form><br>
&nbsp;
