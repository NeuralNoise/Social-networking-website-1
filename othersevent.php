...
<body>
<center>
<h1>EVENTS OTHERS ARE ATTENDING</h1>
...
$result = mysqli_query($con,"SELECT distinct name,event_name,start FROM otherevents WHERE event_name NOT IN (SELECT name FROM myevents)");
...
echo "<td><h3>" . $row['event_name'] . "</td></h3>";
