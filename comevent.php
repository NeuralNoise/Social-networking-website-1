...
<body>
<center>
<h1>PEOPLE ATTENDING YOUR EVENTS</h1>
...
$result = mysqli_query($con,"SELECT distinct name,event_name,start FROM otherevents WHERE event_name IN (SELECT name FROM myevents)");
